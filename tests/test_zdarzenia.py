...
from src.zdarzenia import ( Walentynki, NaglaSusza, Epidemia, Weterynarz, Meteoryt, MlekoGMO, Wielkanoc,
                            UFO, Lesniczy, PoraDeszczowa, ZazdrosnaKoza, CudNadOdra)
...
class Sztuczna_farma:
    def __init__(self, stado=None):
        self.stado = stado if stado is not None else [] #jesli lista jest wez ja, jesli nie stworz pusta
